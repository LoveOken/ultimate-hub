...
let do_once_connected = function() {
...
let display_every_role = function(role, index, active, subindex, onclick) {
...
let do_after_roles_are_displayed = function() {
...
let update_active_roles = function(role, index, active, subindex) {
    document.getElementById(role.name + subindex).checked = active;
};

let display_if_seated = function(my_player) {
    DISPLAY_SEAT("SEATS-STAND");
